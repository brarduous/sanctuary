interface ChapterData {
    [chapter: number]: number; // Key: chapter number, Value: number of verses
  }
  ...
  export const bibleData: BibleData = {
    ...
    "Ruth": { name: "Ruth", chapters: { 1: 22, 2: 23, 3: 18, 4: 22 } },
    "1 Samuel": {
      name: "1 Samuel",
      chapters: {
    ...
    "Ezra": { name: "Ezra", chapters: { 1: 11, 2: 70, 3: 13, 4: 24, 5: 17, 6: 22, 7: 28, 8: 36, 9: 15, 10: 44 } },
    "Nehemiah": {
      name: "Nehemiah",
      chapters: {
    ...
    "Esther": { name: "Esther", chapters: { 1: 22, 2: 23, 3: 15, 4: 17, 5: 14, 6: 14, 7: 10, 8: 17, 9: 32, 10: 3 } },
    "Job": {
      name: "Job",
      chapters: {
    ...
    "Ecclesiastes": {
      name: "Ecclesiastes",
      chapters: { 1: 18, 2: 26, 3: 22, 4: 16, 5: 20, 6: 12, 7: 29, 8: 17, 9: 18, 10: 20, 11: 10, 12: 14 }
    },
    "Song of Solomon": {
      name: "Song of Solomon",
      chapters: { 1: 17, 2: 17, 3: 11, 4: 16, 5: 16, 6: 13, 7: 13, 8: 14 }
    },
    "Isaiah": {
      name: "Isaiah",
      chapters: {
    ...
    "Lamentations": { name: "Lamentations", chapters: { 1: 22, 2: 22, 3: 66, 4: 22, 5: 22 } },
    "Ezekiel": {
      name: "Ezekiel",
      chapters: {
    ...
    "Daniel": {
      name: "Daniel",
      chapters: { 1: 21, 2: 49, 3: 30, 4: 37, 5: 31, 6: 28, 7: 28, 8: 27, 9: 27, 10: 21, 11: 45, 12: 13 }
    },
    "Hosea": {
      name: "Hosea",
      chapters: { 1: 11, 2: 23, 3: 5, 4: 19, 5: 15, 6: 11, 7: 16, 8: 14, 9: 17, 10: 15, 11: 12, 12: 14, 13: 16, 14: 9 }
    },
    "Joel": { name: "Joel", chapters: { 1: 20, 2: 32, 3: 21 } },
    "Amos": { name: "Amos", chapters: { 1: 15, 2: 16, 3: 15, 4: 13, 5: 27, 6: 14, 7: 17, 8: 14, 9: 15 } },
    "Obadiah": { name: "Obadiah", chapters: { 1: 21 } },
    "Jonah": { name: "Jonah", chapters: { 1: 17, 2: 10, 3: 10, 4: 11 } },
    "Micah": { name: "Micah", chapters: { 1: 16, 2: 13, 3: 12, 4: 13, 5: 15, 6: 16, 7: 20 } },
    "Nahum": { name: "Nahum", chapters: { 1: 15, 2: 13, 3: 19 } },
    "Habakkuk": { name: "Habakkuk", chapters: { 1: 17, 2: 20, 3: 19 } },
    "Zephaniah": { name: "Zephaniah", chapters: { 1: 18, 2: 15, 3: 20 } },
    "Haggai": { name: "Haggai", chapters: { 1: 15, 2: 23 } },
    "Zechariah": {
      name: "Zechariah",
      chapters: { 1: 21, 2: 13, 3: 10, 4: 14, 5: 11, 6: 15, 7: 14, 8: 23, 9: 17, 10: 12, 11: 17, 12: 14, 13: 9, 14: 21 }
    },
    "Malachi": { name: "Malachi", chapters: { 1: 14, 2: 17, 3: 18, 4: 6 } },
    ...
    "2 Corinthians": {
      name: "2 Corinthians",
      chapters: { 1: 24, 2: 17, 3: 18, 4: 18, 5: 21, 6: 18, 7: 16, 8: 24, 9: 15, 10: 18, 11: 33, 12: 21, 13: 14 }
    },
    "Galatians": { name: "Galatians", chapters: { 1: 24, 2: 21, 3: 29, 4: 31, 5: 26, 6: 18 } },
    "Ephesians": { name: "Ephesians", chapters: { 1: 23, 2: 22, 3: 21, 4: 32, 5: 33, 6: 24 } },
    "Philippians": { name: "Philippians", chapters: { 1: 30, 2: 30, 3: 21, 4: 23 } },
    "Colossians": { name: "Colossians", chapters: { 1: 29, 2: 23, 3: 25, 4: 18 } },
    "1 Thessalonians": { name: "1 Thessalonians", chapters: { 1: 10, 2: 20, 3: 13, 4: 18, 5: 28 } },
    "2 Thessalonians": { name: "2 Thessalonians", chapters: { 1: 12, 2: 17, 3: 18 } },
    "1 Timothy": { name: "1 Timothy", chapters: { 1: 20, 2: 15, 3: 16, 4: 16, 5: 25, 6: 21 } },
    "2 Timothy": { name: "2 Timothy", chapters: { 1: 18, 2: 26, 3: 17, 4: 22 } },
    "Titus": { name: "Titus", chapters: { 1: 16, 2: 15, 3: 15 } },
    "Philemon": { name: "Philemon", chapters: { 1: 25 } },
    "Hebrews": {
      name: "Hebrews",
      chapters: { 1: 14, 2: 18, 3: 19, 4: 16, 5: 14, 6: 20, 7: 28, 8: 13, 9: 28, 10: 39, 11: 40, 12: 29, 13: 25 }
    },
    "James": { name: "James", chapters: { 1: 27, 2: 26, 3: 18, 4: 17, 5: 20 } },
    "1 Peter": { name: "1 Peter", chapters: { 1: 25, 2: 25, 3: 22, 4: 19, 5: 14 } },
    "2 Peter": { name: "2 Peter", chapters: { 1: 21, 2: 22, 3: 18 } },
    "1 John": { name: "1 John", chapters: { 1: 10, 2: 29, 3: 24, 4: 21, 5: 21 } },
    "2 John": { name: "2 John", chapters: { 1: 13 } },
    "3 John": { name: "3 John", chapters: { 1: 14 } }, // Note: Some count 15 verses, others 14. 14 is common.
    "Jude": { name: "Jude", chapters: { 1: 25 } },
    "Revelation": {
      name: "Revelation",
      chapters: {
  ...
  // Example: How to get the number of verses in Genesis chapter 1
  // console.log(bibleData["Genesis"].chapters[1]); // Output: 31
  
  // Example: How to get the list of chapter numbers for Exodus
  // console.log(Object.keys(bibleData["Exodus"].chapters).map(Number)); // Output: [1, 2, ..., 40]
  
  // You can export this variable if you are using modules
